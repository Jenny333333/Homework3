...
DROP TABLE IF EXISTS `picturegallery`;
...
LOCK TABLES `picturegallery` WRITE;
/*!40000 ALTER TABLE `picturegallery` DISABLE KEYS */;
INSERT INTO `picturegallery` VALUES (1,'test1');
/*!40000 ALTER TABLE `picturegallery` ENABLE KEYS */;
UNLOCK TABLES;
